...
namespace dpn
{
    ...
    /// </summary>
    public class DpnHMDPointer : DpnBasePointer
    {
        /// <summary>
        ...
        void Awake()
        {
            kReticleDistanceMax = DpnCameraRig._instance._center_eye.farClipPlane * 0.99f;
            SetTitledAngle(0);
        }
        ...
        protected void Start()
        {
            ...
            {
                transform.SetParent(DpnUICamera.instance.centerCamera.transform, false);
                transform.gameObject.layer = 5; // UI Layer
        ...
        /// <param name="intersectionPosition"></param>
        /// <param name="intersectionRay"></param>
        ...
        {
            reticleLocalPosition = new Vector3(0, offsetY, distanceMax);
        ...
        {
            return DpnCameraRig._instance._center_transform;
        }
        ...
        {
            //transform.localPosition = reticleLocalPosition;
        ...
        protected void SetPointerTarget(Vector3 target, bool interactive)
        {
            if (DpnUICamera.instance != null)
            {
                Vector3 screenPos = DpnCameraRig._instance._center_eye.WorldToScreenPoint(target);
                transform.position = DpnUICamera.instance.centerCamera.ScreenToWorldPoint(screenPos); ;
            }
            else
